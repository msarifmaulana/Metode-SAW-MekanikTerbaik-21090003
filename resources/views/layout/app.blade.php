    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('home')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Mekanik Terbaik</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item" {{ is_hidden('home') }}>
                            <a href="{{ route('home') }}" class="nav-link">
                                <i class="far fa-folder-open" style="font-size:25px;color:green;"></i>
                                <p>
                                    Home
                                </p>
                            </a>
        ...
        <footer class="main-footer d-print-none">
            <div class="float-right d-none d-sm-block">
                Designed by <a href="https://www.youtube.com/channel/UCHIQkzxRJIHG8D97uuJpSXw?view_as=subscriber">M Sarif Maulana</a>
            </div>
            <strong>Copyright &copy; {{ date('Y') }} M Sarif Maulana | 21090003 </strong> All rights reserved.
        </footer>
